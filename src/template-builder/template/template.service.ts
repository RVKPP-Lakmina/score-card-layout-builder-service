...
import {
  ReponseSingleData,
  ResponseManyData,
} from 'src/types/common-responses.types';
...
export class TemplateService extends Helpers {
  ...
  async findOne(templateId: string): ReponseSingleData<Template> {
  ...
  async findAll(): ResponseManyData<Template> {
    try {
      ...
      templates.forEach((template) => {
        ...
        result[template.id.toString()] = template;
      });
